...
import loginBackgroundImage from "../../assets/loginPageBackgroundImage.png";
import "./Login.css";
        ...
        <div className="login-card">
          <div className="login-card-header">
            <div className="login-logo">
              ...
              >
                <path
                  d="M8.86879 12.5795C8.30827 12.5795 7.85785 13.0395 7.85785 13.5995C7.85785 14.1595 8.31828 14.6195 8.86879 14.6195C9.41931 14.6195 9.88974 14.1595 9.88974 13.5995C9.87974 13.0395 9.43932 12.5795 8.86879 12.5795Z"
                  fill="white"
                />
                <path
              ...
              <span className="login-brand">Kloudspot</span>
            </div>
          </div>
          ...
          <div className="login-card-body">
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                <label htmlFor="email">
                  Log In <span className="required-asterisk">*</span>
                </label>
                <input
                  id="email"
                  type="email"
